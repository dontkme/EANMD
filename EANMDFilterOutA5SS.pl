...
#AUTHORS
# Kaining Hu (c) 2025
# Filter EANMD A5SS outCombined file v1.10 2025/03/07
# hukaining@gmail.com
...
or die("[-]Error in command line arguments
  Usage: perl EANMDFilterOutA5SS.pl [options]  <input EANMD A5SS outCombined file>
    ...
    Note: Filter the records in EANMD A5SS outCombined file by start codon, #IR, CDS length #and Last Exon. v1.10 2025/03/07.\n");
